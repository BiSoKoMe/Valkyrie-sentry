...
| domain | bg | heartbeat | app-closed | never-seen | timing-dev | asym | **anomaly** | threat-graph | beh-entropy (raw→×0.5) | beh-rate | beh-age | **beh total** | **FINAL** |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
